...
public class MainActivity extends AppCompatActivity {
    ...
    private void solicitarToken() {
        ...
        enviarTokenRegistro(token ,id_usuario_instragram );

    }

    private void enviarTokenRegistro(String token, String idInsta) {
        ...
        Call<UsuarioResponse> usuarioResponseFirebaseCall = endpointsFirebase.registrarTokenID(token,idInsta);
